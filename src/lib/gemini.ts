...
2. **Quantities**: Convert natural language to grams (solids) or ml (liquids):
   ...
   - **Cooked vs raw (Indian foods)**: When a user gives a weight for a food that can be raw or cooked (rice, dal, pasta, oats, etc.), always assume COOKED. "100g rice" means 100g cooked rice, "150g arhar dal" means 150g cooked arhar dal. Only treat as raw if the user explicitly says "raw" or "uncooked".
